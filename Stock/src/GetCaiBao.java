...
public class GetCaiBao {
    ...
    public static void main(String[] args) {
        ...
        for(String str:strs) {
        	 try{
                 downLoadFromUrl("http://basic.10jqka.com.cn/api/stock/export.php?export=debt&type=year&code="+str,
                         str+"_debt.xls","./caibao/");
                 downLoadFromUrl("http://basic.10jqka.com.cn/api/stock/export.php?export=cash&type=year&code="+str,
                         str+"_cash.xls","./caibao/");
                 downLoadFromUrl("http://basic.10jqka.com.cn/api/stock/export.php?export=benefit&type=year&code="+str,
                         str+"_benefit.xls","./caibao/");
//                 Thread.sleep(100);
             }catch (Exception e) {
                 e.printStackTrace();
             }
